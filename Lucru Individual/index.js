...
app.service('calc', function() {
    this.myitems = [];
    this.getValue = function () { return this.myitems }; //getter
...
app.controller("homeCtrl", function($scope,register,login,localData, calc) {
    $scope.items = [
        {nume: "Apple Macbook Pro", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product-large/apple-macbook-pro-16-sg.png", pretul: 23.599},
        {nume: "Asus TUF FX505DT", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/asus-rog-strix-g15-g512.png", pretul: 21.489},
        {nume: "Acer Swift 3 SF314-57", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/acer-swift-3-sf314-57-p.png", pretul: 14.599},
        {nume: "Lenovo ThinkBook 15", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/lenovo-thinkbook-15-iml.png", pretul: 16.349},
        {nume: "HP EliteBook 855 G7", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/hp-elitebook-855-g7.png", pretul: 19.369},
        {nume: "Dell Inspiron 15 5501", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/dell-inspiron-15-5501-s.png", pretul: 14.649},
        {nume: "Acer Nitro 5 AN515-54", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/acer-nitro-5-an515-54.png", pretul: 21.499},
        {nume: "Apple MacBook Air", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/apple-macbook-air-2020-sg.png", pretul: 22.599},   
        {nume: "Apple MacBook Air", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/apple-macbook-air-2020-s_0.png", pretul: 21.499},
        {nume: "ZenBook ASUS 14", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/asus-zenbook-14-ux433fac-bl.png", pretul: 29.299},
        {nume: "Dell XPS 15 9575", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/dell-xps-15-9575.png", pretul: 28.599},   
        {nume: "Xiaomi Mi Gaming Laptop", imagineURL: "https://www.zap.md/sites/default/files/imagecache/product_by_category/xiaomi-mi-gaming-laptop.png", pretul: 32.999},   
    ]
