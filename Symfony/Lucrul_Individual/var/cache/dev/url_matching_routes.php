...
return [
    ...
    [ // $dynamicRoutes
        ...
        375 => [[['_route' => 'app_product_update', '_controller' => 'App\\Controller\\ProductController::update'], ['id'], null, null, false, true, null]],
        398 => [
            [['_route' => 'app_product_remove', '_controller' => 'App\\Controller\\ProductController::remove'], ['id'], null, null, false, true, null],
