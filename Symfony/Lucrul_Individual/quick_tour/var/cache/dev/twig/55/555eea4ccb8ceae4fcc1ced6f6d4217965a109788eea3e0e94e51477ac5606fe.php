...
class __TwigTemplate_261d57b3071716cc52d3fcb5ff78ece04587746e37ab7ceafac9fe47844777ba extends Template
{
    private $source;
    private $macros = [];
    ...
    <td> ";
      ...
      <td> ";
        ...
        <td>*";
          ...
          <td> ";
            // line 39
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "category", [], "any", false, false, false, 39), "name", [], "any", false, false, false, 39), "html", null, true);
            echo " </td>
                  <td>
            <div class=\"d-flex justify-content-around\">
            <a href=\"";
            // line 42
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit_product", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 42)]), "html", null, true);
            echo "\">Update</a>
            <a class=\"text-danger\" href=\"";
            // line 43
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("delete_product", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 43)]), "html", null, true);
            echo "\">Delete</a>
            </div>
        </td>
    </tr>
...
<form action=\"";
        ...
        echo "\">
    <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block\">Creaza Product Nou</button>
</form>
...
";
    ...
    {
        return array (  173 => 53,  168 => 50,  161 => 48,  151 => 43,  147 => 42,  141 => 39,  137 => 38,  133 => 37,  129 => 36,  124 => 34,  121 => 33,  116 => 32,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
      ...
      <td> {{ product.price }} </td>
        <td>*{{ product.description }} </td>
          <td> {{ product.category.name }} </td>
                  <td>
            <div class=\"d-flex justify-content-around\">
            <a href=\"{{path('edit_product',{id:product.id})}}\">Update</a>
            <a class=\"text-danger\" href=\"{{path('delete_product',{id:product.id})}}\">Delete</a>
            </div>
        </td>
    </tr>
{% else %}
...
{% endblock %}
", "product/index.html.twig", "C:\\Users\\User\\Desktop\\Adrian Individual\\quick_tour\\templates\\product\\index.html.twig");
    }
}
