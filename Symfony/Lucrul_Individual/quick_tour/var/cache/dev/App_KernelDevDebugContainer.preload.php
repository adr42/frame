...
require __DIR__.'/Container1dNHxTa/App_KernelDevDebugContainer.php';
require __DIR__.'/Container1dNHxTa/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/Container1dNHxTa/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/Container1dNHxTa/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/Container1dNHxTa/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container1dNHxTa/getValidator_ExpressionService.php';
require __DIR__.'/Container1dNHxTa/getValidator_EmailService.php';
require __DIR__.'/Container1dNHxTa/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container1dNHxTa/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container1dNHxTa/getTwig_Form_RendererService.php';
require __DIR__.'/Container1dNHxTa/getSession_Storage_NativeService.php';
require __DIR__.'/Container1dNHxTa/getSessionService.php';
require __DIR__.'/Container1dNHxTa/getServicesResetterService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_PasswordEncoderService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_ContextListener_0Service.php';
require __DIR__.'/Container1dNHxTa/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/Container1dNHxTa/getSecurity_AccessListenerService.php';
require __DIR__.'/Container1dNHxTa/getSecrets_VaultService.php';
require __DIR__.'/Container1dNHxTa/getRouting_LoaderService.php';
require __DIR__.'/Container1dNHxTa/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container1dNHxTa/getMonolog_Logger_SecurityService.php';
require __DIR__.'/Container1dNHxTa/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/Container1dNHxTa/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/Container1dNHxTa/getForm_Type_FormService.php';
require __DIR__.'/Container1dNHxTa/getForm_Type_FileService.php';
require __DIR__.'/Container1dNHxTa/getForm_Type_EntityService.php';
require __DIR__.'/Container1dNHxTa/getForm_Type_ColorService.php';
require __DIR__.'/Container1dNHxTa/getForm_Type_ChoiceService.php';
require __DIR__.'/Container1dNHxTa/getForm_ServerParamsService.php';
require __DIR__.'/Container1dNHxTa/getForm_RegistryService.php';
require __DIR__.'/Container1dNHxTa/getForm_FactoryService.php';
require __DIR__.'/Container1dNHxTa/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/Container1dNHxTa/getFilesystemService.php';
require __DIR__.'/Container1dNHxTa/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/Container1dNHxTa/getErrorControllerService.php';
require __DIR__.'/Container1dNHxTa/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container1dNHxTa/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container1dNHxTa/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container1dNHxTa/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container1dNHxTa/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container1dNHxTa/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container1dNHxTa/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container1dNHxTa/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container1dNHxTa/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container1dNHxTa/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container1dNHxTa/getContainer_GetenvService.php';
require __DIR__.'/Container1dNHxTa/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container1dNHxTa/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container1dNHxTa/getCacheClearerService.php';
require __DIR__.'/Container1dNHxTa/getCache_SystemClearerService.php';
require __DIR__.'/Container1dNHxTa/getCache_GlobalClearerService.php';
require __DIR__.'/Container1dNHxTa/getCache_AppClearerService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/Container1dNHxTa/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/Container1dNHxTa/getAnnotations_CacheService.php';
require __DIR__.'/Container1dNHxTa/getTemplateControllerService.php';
require __DIR__.'/Container1dNHxTa/getRedirectControllerService.php';
require __DIR__.'/Container1dNHxTa/getProductRepositoryService.php';
require __DIR__.'/Container1dNHxTa/getProdRepositoryService.php';
require __DIR__.'/Container1dNHxTa/getCategoryRepositoryService.php';
require __DIR__.'/Container1dNHxTa/getTaskTypeService.php';
require __DIR__.'/Container1dNHxTa/getTaskControllerService.php';
require __DIR__.'/Container1dNHxTa/getProductControllerService.php';
require __DIR__.'/Container1dNHxTa/getDefaultControllerService.php';
require __DIR__.'/Container1dNHxTa/getCategoryControllerService.php';
require __DIR__.'/Container1dNHxTa/get_ServiceLocator_ZXCb2dEService.php';
require __DIR__.'/Container1dNHxTa/get_ServiceLocator_G9CqTPpService.php';
require __DIR__.'/Container1dNHxTa/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/Container1dNHxTa/get_ServiceLocator_C9JCBPCService.php';
require __DIR__.'/Container1dNHxTa/get_ServiceLocator_02NeO4QService.php';
...
$classes[] = 'App\Repository\ProdRepository';
