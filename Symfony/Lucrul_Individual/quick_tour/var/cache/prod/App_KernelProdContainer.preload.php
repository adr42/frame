...
require __DIR__.'/ContainerNb4PypK/App_KernelProdContainer.php';
require __DIR__.'/ContainerNb4PypK/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerNb4PypK/getValidator_ExpressionService.php';
require __DIR__.'/ContainerNb4PypK/getValidator_EmailService.php';
require __DIR__.'/ContainerNb4PypK/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerNb4PypK/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerNb4PypK/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerNb4PypK/getTwigService.php';
require __DIR__.'/ContainerNb4PypK/getSession_Storage_NativeService.php';
require __DIR__.'/ContainerNb4PypK/getSessionService.php';
require __DIR__.'/ContainerNb4PypK/getServicesResetterService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_UserValueResolverService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_PasswordEncoderService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_ContextListener_0Service.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerNb4PypK/getSecurity_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerNb4PypK/getSecrets_VaultService.php';
require __DIR__.'/ContainerNb4PypK/getRouting_LoaderService.php';
require __DIR__.'/ContainerNb4PypK/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerNb4PypK/getMonolog_Logger_SecurityService.php';
require __DIR__.'/ContainerNb4PypK/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerNb4PypK/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerNb4PypK/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerNb4PypK/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerNb4PypK/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerNb4PypK/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerNb4PypK/getForm_Type_FormService.php';
require __DIR__.'/ContainerNb4PypK/getForm_Type_FileService.php';
require __DIR__.'/ContainerNb4PypK/getForm_Type_EntityService.php';
require __DIR__.'/ContainerNb4PypK/getForm_Type_ColorService.php';
require __DIR__.'/ContainerNb4PypK/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerNb4PypK/getForm_ServerParamsService.php';
require __DIR__.'/ContainerNb4PypK/getForm_RegistryService.php';
require __DIR__.'/ContainerNb4PypK/getForm_FactoryService.php';
require __DIR__.'/ContainerNb4PypK/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerNb4PypK/getFilesystemService.php';
require __DIR__.'/ContainerNb4PypK/getErrorControllerService.php';
require __DIR__.'/ContainerNb4PypK/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerNb4PypK/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerNb4PypK/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerNb4PypK/getContainer_GetenvService.php';
require __DIR__.'/ContainerNb4PypK/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerNb4PypK/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerNb4PypK/getCacheClearerService.php';
require __DIR__.'/ContainerNb4PypK/getCache_SystemClearerService.php';
require __DIR__.'/ContainerNb4PypK/getCache_SystemService.php';
require __DIR__.'/ContainerNb4PypK/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerNb4PypK/getCache_AppClearerService.php';
require __DIR__.'/ContainerNb4PypK/getCache_AppService.php';
require __DIR__.'/ContainerNb4PypK/getCache_AnnotationsService.php';
require __DIR__.'/ContainerNb4PypK/getArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerNb4PypK/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerNb4PypK/getAnnotations_CacheService.php';
require __DIR__.'/ContainerNb4PypK/getTemplateControllerService.php';
require __DIR__.'/ContainerNb4PypK/getRedirectControllerService.php';
require __DIR__.'/ContainerNb4PypK/getProdRepositoryService.php';
require __DIR__.'/ContainerNb4PypK/getGreetingGeneratorService.php';
require __DIR__.'/ContainerNb4PypK/getTaskTypeService.php';
require __DIR__.'/ContainerNb4PypK/getTaskControllerService.php';
require __DIR__.'/ContainerNb4PypK/getProductControllerService.php';
require __DIR__.'/ContainerNb4PypK/getDefaultControllerService.php';
require __DIR__.'/ContainerNb4PypK/get_ServiceLocator_O3sIu7CService.php';
require __DIR__.'/ContainerNb4PypK/get_ServiceLocator_G9CqTPpService.php';
require __DIR__.'/ContainerNb4PypK/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/ContainerNb4PypK/get_ServiceLocator_C9JCBPCService.php';
...
$classes = [];
$classes[] = 'F:\\symfony\\Lab5\\quick_tour\\var\\cache\\prod/doctrine/orm/Proxies/__CG__AppEntityProd.php';
Preloader::preload($classes);
